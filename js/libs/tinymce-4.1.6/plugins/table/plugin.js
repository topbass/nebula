...
define("tinymce/tableplugin/Plugin", [
	...
	function Plugin(editor) {
		...
		editor.addButton('tableaddrow', {
			// text: '+Row',
			// icon: false,
			title: "Insert Row After",
			image: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQBAMAAADt3eJSAAAAFVBMVEX///9vb29vb29vb29vb29wcHBvb29gR3jfAAAABXRSTlMAIoiZqrH2UJkAAAAnSURBVAhbY2AIBYIABijAwSBfDQQYQGnmBAaIKrW0BAhDBCYCVQMAVOgNLbt4HlgAAAAASUVORK5CYII=",
			onPostRender: postRender,
			cmd: 'mceTableInsertRowAfter'
		});

		editor.addButton('tableaddcol', {
			// text: '+Column',
			// icon: false,
			title: "Insert Column After",
			image: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQBAMAAADt3eJSAAAAFVBMVEX///9vb29vb29vb29vb29wcHBvb29gR3jfAAAABXRSTlMAIlWZqjSn9voAAAAtSURBVAhbY2CAgQAwZBKAMswcIAzmtGSoCBsDOgOuKzQAwQgFARADAohhIAEAw10PDUcrKgoAAAAASUVORK5CYII=",
			onPostRender: postRender,
			cmd: 'mceTableInsertColAfter'
		});

		editor.addButton('tableheaderprop', {
			// text: 'Header',
			// icon: false,
			title: "Heading Row",
			image: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQAgMAAABinRfyAAAACVBMVEX///9wcHBwcHDMVYRVAAAAAnRSTlMAVW2SaEMAAAAgSURBVAhbY2AAgVVAwDA1NTIMiQCLNShwMCEROMXgAACCthOYbGrVnQAAAABJRU5ErkJggg==",
			onPostRender: postRender,
